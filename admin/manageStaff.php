               ...
               <div class="col-md-12">
                    <div class="table-responsive">
                       <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tbody>
                                 <?php
                                        $results = $object->allStaff();
                                        if(!empty($results)){
                                        $i=1;
                                        foreach($results as $value) { 
                                    ?> 
                                <tr>
                                  <td><img width="28" height="28" src="<?=$value['passport']?>" class="rounded-circle m-r-5" alt=""><?=$value['lastName']. " ". $value['otherName']?></td>
                                  <td><?=$value['email']?></td>
                                  <td><?=$value['phoneNo']?></td>
                                  <td class="text-right">
